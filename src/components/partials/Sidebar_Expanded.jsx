...
const Sidebar_Expanded = ({setShowSideBar, showSideBar}) => {
    ...
    return (
        <div className={`sidebar-expanded-parent fixed top-0 left-0 h-full xl:h-full w-full xl:w-60 transition-all duration-300 ${showSideBar ? 'bg-black/40 xl:bg-transparent z-[999]' : 'bg-none z-[-1]'}`}>
            <div className={`sidebar-expanded bg-dark_bg h-full overflow-y-scroll custom-scroll_b transition-all duration-300 w-60 ${showSideBar ? 'translate-x-0' : '-translate-x-full'}`}>
                <div className='flex items-center gap-6 pl-6 h-14'>
                    ...
                    <button className="sidebar-link-item">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" focusable="false">
                            ...
                            <g fill="none" fill-rule="evenodd">
                                ...
                                <path fill="url(#a_yt46)" fill-opacity=".1" d="M21.54 3.4s-.2-1.5-.86-2.18C19.85.35 18.93.35 18.5.3 15.46.07 10.9.1 10.9.1S6.34.07 3.3.3c-.43.05-1.35.05-2.18.92C.47 1.9.26 3.4.26 3.4S.04 5.17 0 6.95V8.6c.04 1.8.26 3.56.26 3.56s.2 1.52.86 2.18c.83.87 1.9.85 2.4.94 1.7.16 7.2.2 7.38.2 0 0 4.57 0 7.6-.2.43-.06 1.35-.07 2.18-.94.65-.66.86-2.18.86-2.18s.22-1.77.24-3.55V6.97c-.02-1.78-.24-3.55-.24-3.55z" transform="translate(1 4.208)"></path>
                                </g>
                            </g>
                        </svg>
                        <p>YouTube Premium</p>
