  ...
  return (
    <div className='yt_video_card f-col-center'>
        <Link to={'#'} className='relative'>
            ...
            <span className='text-xs ft-sb bg-black/75 px-1.5 py-0.5 rounded-md absolute bottom-2 right-2 text-white'>{video.length}</span>
        </Link>
        <div className="video_card_info grid grid-cols-[36px_1fr] gap-3 pr-6 mt-3">
            ...
            <div className='f-col'>
                <h4 className='line-clamp-2 text-ellipsis ft-md text-wrap text-base leading-[20px] text-text_primary mb-2 pointer hover:text-text_primary'>{video.title}</h4>
