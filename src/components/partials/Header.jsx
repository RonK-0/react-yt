...
import user from '../../../public/img/global_icons/user.jpg'
        ...
        <div className='searchBox_parent flex betweeen-center gap-4 w-1/2 md:w-[54.5%] xl:w-[35%] 2xl:w-[37.5%]'>
          <div className='searchBox relative bg-[#121212] rounded-full min-h-10 max-h-10 w-full h-full py-2 flex items-center ml-8 border border-outline'>
            <div className="box border border-transparent flex items-center rounded-tl-full rounded-bl-full pl-[14px] w-full">
              ...
              <div className='hidden-search-icon h-6 w-8 left-4 hidden'><svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24" focusable="false"><path d="m20.87 20.17-5.59-5.59C16.35 13.35 17 11.75 17 10c0-3.87-3.13-7-7-7s-7 3.13-7 7 3.13 7 7 7c1.75 0 3.35-.65 4.58-1.71l5.59 5.59.7-.71zM10 16c-3.31 0-6-2.69-6-6s2.69-6 6-6 6 2.69 6 6-2.69 6-6 6z"></path></svg></div>
            </div>

            {/* Search button */}
            <button type="button" className='bg-raised_bg rounded-tr-full rounded-br-full w-full max-w-16 h-10 f-col-center'>
